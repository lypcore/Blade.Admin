...
namespace Blade.Service
{
    ...
    public abstract class BaseService<T> where T : class, new()
    {
        ...
        public BaseService(IDbAccessor db)
        {
            Db = db;
        }
        ...
        /// <summary>
        /// 使用SQL语句按照条件删除数据
        /// 用法:Delete_Sql"BaseUser"(x=&gt;x.Id == "Admin")
        /// 注：生成的SQL类似于DELETE FROM [BaseUser] WHERE [Name] = 'xxx' WHERE [Id] = 'Admin'
        /// </summary>
        ...
        /// <summary>
        /// 使用SQL语句按照条件更新
        /// 用法:UpdateWhere_Sql"BaseUser"(x=>x.Id == "Admin",("Name","小明"))
