...
const devRouter = [
  {
    ...
    children: [
      {
        path: '/BaseManage/BaseDbLink/List',
        title: '数据库连接'
      },
      {
        path: '/BaseManage/BuildCode/List',
        title: '代码生成'
      },
      {
...
const getRouterByUser = () => {
  // return Axios.post('/BaseManage/BaseAction/GetMenuTreeList')
  return new Promise((resolve, reject) => {
    Axios.post('/BaseManage/Home/GetOperatorMenuList', {}).then(resJson => {
      if (resJson.Success) {
