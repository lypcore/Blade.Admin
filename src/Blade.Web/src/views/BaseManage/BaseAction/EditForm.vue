...
export default {
  ...
  methods: {
    init(id) {
      ...
      this.$http.post('/BaseManage/BaseAction/GetMenuTreeList', {}).then(resJson => {
        if (resJson.Success) {
    ...
    openForm(id) {
      ...
      if (id) {
        this.$http.post('/BaseManage/BaseAction/GetTheData', { id: id }).then(resJson => {
    ...
    handleSubmit() {
      this.$refs['form'].validate(valid => {
        ...
        this.$http.post('/BaseManage/BaseAction/SaveData', this.entity).then(resJson => {
