...
export default {
  ...
  methods: {
    init() {
      ...
      this.$http.post('/BaseManage/BaseDepartment/GetTreeDataList', {}).then(resJson => {
        if (resJson.Success) {
          this.DepartmentIdTreeData = resJson.Data
        }
      })
      this.$http.post('/BaseManage/BaseRole/GetDataList', {}).then(resJson => {
        if (resJson.Success) {
    ...
    openForm(id) {
      ...
      if (id) {
        this.$http.post('/BaseManage/BaseUser/GetTheData', { id: id }).then(resJson => {
    ...
    handleSubmit() {
      this.$refs['form'].validate(valid => {
        ...
        this.$http.post('/BaseManage/BaseUser/SaveData', this.entity).then(resJson => {
