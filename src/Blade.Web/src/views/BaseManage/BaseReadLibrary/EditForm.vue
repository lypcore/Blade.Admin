    ...
    <a-spin :spinning="loading">
      <a-form-model ref="form" :model="entity" :rules="rules" v-bind="layout">
        ...
        <a-form-model-item label="权重" prop="HitRate">
          <a-input v-model="entity.HitRate" autocomplete="off" />
        </a-form-model-item>
        <a-form-model-item label="连接字符串" prop="ConnectionString">
          <a-input v-model="entity.ConnectionString" autocomplete="off" />
        </a-form-model-item>
        <a-form-model-item label="启用（0禁用，1启用）" prop="IsEnable">
          <a-input v-model="entity.IsEnable" autocomplete="off" />
        </a-form-model-item>
        <a-form-model-item label="被链接次数" prop="ConnectionTotal">
          <a-input v-model="entity.ConnectionTotal" autocomplete="off" />
        </a-form-model-item>
        <a-form-model-item label="数据库类型" prop="DbType">
          <a-input v-model="entity.DbType" autocomplete="off" />
        </a-form-model-item>
      </a-form-model>
    </a-spin>
  </a-modal>
